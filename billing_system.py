...
#================totalBill==========================
    ...
    def total(self):
        ...
        self.medical_price.set("NGN. "+str(self.total_medical_price))
        self.c_tax = round((self.total_medical_price*0.05), 2)
        self.medical_tax.set("NGN. "+str(self.c_tax))
        ...
        self.grocery_price.set("NGN. " + str(self.total_grocery_price))
        self.g_tax = round((self.total_grocery_price*5), 2)
        self.grocery_tax.set("NGN. " + str(self.g_tax))
        ...
        self.cold_drinks_price.set("NGN. "+str(self.total_cold_drinks_price))
        self.c_d_tax = round((self.total_cold_drinks_price * 0.1), 2)
        self.cold_drinks_tax.set("NGN. "+str(self.c_d_tax))
...
#=========billArea=================================================
    ...
    def bill_area(self):
        ...
        elif self.medical_price.get() == "NGN. 0.0" and self.grocery_price.get() == "NGN. 0.0" and self.cold_drinks_price.get()=="NGN. 0.0":
